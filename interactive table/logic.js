...
// Fetch the CSV data and convert to array of objects
fetch(csvFilePath)
...
function sortTable(columnIndex) {
    ...
    rows.sort((a, b) => {
        const aText = a.querySelector(`td:nth-child(${columnIndex + 1})`).textContent.replace(/[$,]/g, '');
        const bText = b.querySelector(`td:nth-child(${columnIndex + 1})`).textContent.replace(/[$,]/g, '');
